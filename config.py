...
def parse_opts():
    ...
    # Paths
    parser.add_argument('--video_path', type=str, default='D:\\data\\post_data_2020_0219_sub_dataset\\classification\\post_data_2020_0219_2d_all_slice', help='Path to location of dataset videos')
    parser.add_argument('--annotation_path', type=str, required=False, help='Path to location of dataset annotation file')
    parser.add_argument('--save_dir', default='D:\\recurrece_prediction\\PyTorchConv2D_class_5\\output\\baseline', type=str, help='Where to save training outputs.')

    # Dataset
    parser.add_argument('--dataset', type=str, default='MRI', help='Dataset string (MRI,MRI_sub,kinetics | activitynet | ucf101 | blender)')
    ...
    parser.add_argument('--model', default='resnet', type=str, help='(i3d | resnet | preresnet | vgg |wideresnet | resnext | densenet)')
    ...
    #/mass/pengfei/PyTorchConv2D_class_5_1202_head/20191203_1308_MRI_sub_vgg_11_lr0.00010/checkpoints/0.8256880733944955_45_save_best.pth
