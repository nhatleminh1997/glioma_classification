...
def parse_opts():
    ...
    # Paths
    parser.add_argument('--video_path', type=str, default='/data/nhat/CIS_2/119_cases_apt_2_slices', help='Path to location of dataset videos')
    ...
    # Dataset
    parser.add_argument('--dataset', type=str, default='MRI_H', help='Dataset string (MRI,MRI_sub,kinetics | activitynet | ucf101 | blender)')
    ...
    parser.add_argument('--apply_ls_residual', default=False, type=bool, help='learnable subtraction')
    parser.add_argument('--Hierarchical', default=True, type=bool, help='Hierarchical Classification')
    parser.add_argument('--in_chanel', default=4, type=int, help='Number of first conv chanel')
    parser.add_argument('--in_chanel_missing', default='apt', type=str, help='Number of first conv chanel')
    parser.add_argument('--dropout_keep_prob', default=0.5, type=float, help='Dropout keep probability')
    parser.add_argument('--model', default='resnet_h', type=str, help='(i3d | resnet | preresnet | vgg |wideresnet | resnext | densenet)')
    ...
    # Finetuning
    parser.add_argument('--pretrained', default=True, help='load pretrain models')
    ...
    parser.add_argument('--checkpoints_num_keep', type=int, default=150, help='Number of checkpoints to keep')
