...
def parse_opts():
    ...
    parser.add_argument('--save_dir', default='/home/nhat/new_code/PyTorchConv2D_class_5/slice_recurrence_prediction', type=str, help='Where to save training outputs.')
    ...
    parser.add_argument('--Hierarchical', default=False, type=bool, help='Hierarchical Classification')
