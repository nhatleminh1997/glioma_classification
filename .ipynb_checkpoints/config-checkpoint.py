...
def parse_opts():
    ...
    # Paths
    parser.add_argument('--video_path', type=str, default='/mass/pengfei/post_data_1028_2d', help='Path to location of dataset videos')
    parser.add_argument('--annotation_path', type=str, required=False, help='Path to location of dataset annotation file')
    parser.add_argument('--save_dir', default='/mass/pengfei/PyTorchConv2D_class_5_1120_head/', type=str, help='Where to save training outputs.')

    # Dataset
    parser.add_argument('--dataset', type=str, default='MRI_sub', help='Dataset string (MRI,MRI_sub,kinetics | activitynet | ucf101 | blender)')
    ...
    parser.add_argument('--model', default='vgg', type=str, help='(i3d | resnet | preresnet | vgg |wideresnet | resnext | densenet)')


    # Models (3D-ResNet specific)
    parser.add_argument('--model_depth', default=11, type=int, help='Depth of resnet (10 | 18 | 34 | 50 | 101)')
    parser.add_argument('--resnet_shortcut', default='B', type=str, help='Shortcut type of resnet (A | B)')
    parser.add_argument('--wide_resnet_k', default=2, type=int, help='Wide resnet k')
    parser.add_argument('--resnext_cardinality', default=32, type=int, help='ResNeXt cardinality')
    parser.add_argument('--manual_seed', default=888, type=int, help='Manually set random seed')
    ...
    #./checkpoints/100_save_best_5.pth #./checkpoints/100_save_best_5.pth
