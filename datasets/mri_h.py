...
class MRI_h(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if config.in_chanel ==5:
            ...
            if config.in_chanel_missing == 'apt':
                sequences = ['T1.nii','Flair.nii','T2.nii','T1c.nii']
            elif config.in_chanel_missing == 't1c':
                sequences = ['apt.nii','T1.nii','Flair.nii','T2.nii']
        elif config.in_chanel == 3:
            sequences = ['T1.nii', 'Flair.nii', 'T2.nii']
        ...
        return sample, target, loss_mask, target_h, target_hh, study_number
