...
def get_example_params(example_index):
    ...
    example_list = [('D:\\PyTorchConv2D\\salency_example\\019_8_T2.nii', 1)]
    ...
    # Read image
    original_image = load_mri_dataset(img_path_pattern)
    # Define model
    config = parse_opts()
    pretrained_model, _ = model_factory.get_model(config)
    state_dict = torch.load('D:\\PyTorchConv2D\\checkpoints\\save_best.pth')['state_dict']
    # process dict
